...
//        }
    ...
    private void attack(Card target, ImageView targetImage){
        ...
        System.out.println(selectedCard.getName() + " attacked " + target.getName() + " for " + damage + " of damage!");
    ...
    void removeCardFromStage(ImageView cardImage){
        ...
        if (character != null){
            ...
            System.out.println(character.getName() + " has been removed from stage.");
        } //else {
            //System.out.println(character.getName() + " not found on stage.");
        //}
    }
